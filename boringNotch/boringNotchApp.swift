...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        Task { @MainActor in
            ...
            await ApplicationLauncherManager.shared.loadIfNeeded()
            ApplicationLauncherManager.shared.startMonitoring()
            await ApplicationLauncherManager.shared.prewarmIcons()
        }
