...
final class ShelfItemViewModel: ObservableObject {
    ...
    func presentContextMenu(event: NSEvent, in view: NSView) {
        ...
        func addMenuItem(title: String) {
            let mi = NSMenuItem(title: String(localized: String.LocalizationValue(title)), action: nil, keyEquivalent: "")
        ...
        if !selectedFileURLs.isEmpty || !selectedLinkURLs.isEmpty {
            ...
            quickLookItem.representedObject = "Quick Look"
            ...
            slideshowItem.representedObject = "Quick Look"
        ...
        if !imageURLs.isEmpty {
            ...
            if imageURLs.count == 1 {
                ...
                removeBg.representedObject = "Remove Background"
            ...
            if imageURLs.count == 1 {
                ...
                convertItem.representedObject = "Convert Image…"
            ...
            createPDF.representedObject = "Create PDF"
        ...
        if !selectedFileURLs.isEmpty {
            ...
            compressItem.representedObject = "Compress"
        ...
        if !selectedFileURLs.isEmpty {
            ...
            copyPathItem.representedObject = "Copy Path"
    ...
    private final class MenuActionTarget: NSObject {
        ...
        @MainActor @objc func handle(_ sender: NSMenuItem) {
            let actionIdentifier = (sender.representedObject as? String) ?? sender.title
