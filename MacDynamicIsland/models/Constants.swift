...
extension WeatherLocationSelection: Defaults.Serializable {}
extension WeatherProviderPreference: Defaults.Serializable {}
extension HomeModule: Defaults.Serializable {}
...
extension Defaults.Keys {
    ...
    static let weatherLocationSelection = Key<WeatherLocationSelection>(
        "weatherLocationSelection",
        default: .automatic
    )
    static let weatherProviderPreference = Key<WeatherProviderPreference>(
        "weatherProviderPreference",
        default: .automatic
    )
    static let homeModuleOrder = Key<[HomeModule]>(
        "homeModuleOrder",
        default: HomeModuleOrderPolicy.defaultOrder
    )
    static let hideCompletedReminders = Key<Bool>("hideCompletedReminders", default: true)

    // MARK: Daily Todo
    static let showDailyTodo = Key<Bool>("showDailyTodo", default: true)
    static let todoHideCompleted = Key<Bool>("todoHideCompleted", default: false)
    static let todoMaxVisibleItems = Key<Int>("todoMaxVisibleItems", default: 8)
    ...
    // MARK: Launcher
    static let showApplicationLauncher = Key<Bool>("showApplicationLauncher", default: true)
